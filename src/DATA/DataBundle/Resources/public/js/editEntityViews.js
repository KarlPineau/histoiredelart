$(document).ready(function() {
    ...
    var container_entity = $('#data_data_building_views_views');
    if(container_entity === null) {container_entity = $('#data_data_artwork_views_views');}
        container_entity.prev().hide();

    $('[id$=_isPlan]').parent().addClass('form-group col-md-2');
    $('[id$=_vue]').parent().addClass('form-group col-md-2');
    $('[id$=_detail]').parent().addClass('form-group col-md-2');
